...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $required_fields = ['event_name', 'brief_desc', 'start_time', 'end_time', 'room_id', 'event_type', 'booking_id'];
    ...
    if (!isset($error_message)) {
        ...
        $result = update_booking($booking_id, $booking_data);
        
        if ($result['success']) {
            // Build success URL with adjustment info
            $success_url = 'dashboard.php?success=1&booking_id=' . $booking_id . '&updated=1';
